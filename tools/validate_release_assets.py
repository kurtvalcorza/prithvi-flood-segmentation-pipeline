...
REPO_NAME = "prithvi-flood-segmentation-pipeline"
NOTEBOOK_NAME = "prithvi_flood_segmentation_colab.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "ibm-nasa-geospatial/Prithvi-EO-2.0-300M-TL-Sen1Floods11"
PIPELINE_CLASS = "PrithviFloodPipeline"
MODEL_LOAD_EXPR = (
    f"{PIPELINE_CLASS}.from_pretrained(weights_dir=WEIGHTS_DIR, device=('cuda' if torch.cuda.is_available() else 'cpu'), report=print)"
)
KNOWN_SHAS: frozenset[str] = frozenset()
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/prithvi_flood_segmentation_sample_chip.tif",
    "outputs/prithvi_flood_segmentation_sample_label.tif",
    "outputs/prithvi_flood_segmentation_sample_pairs.csv",
    "outputs/prithvi_flood_segmentation_evaluation_report.json",
    "outputs/prithvi_flood_segmentation_predictions.json",
    "outputs/prithvi_flood_segmentation_adapter",
    "outputs/prithvi_flood_segmentation_result.json",
)
CODE_MARKERS = (
    # Stage 3 (fixed cell): the pickle audit and the conversion are printed before the model loads
    "report=print)",
    # Stage 4: pinned Sen1Floods11 chips, roles, sample pair, refusal probes
    "USE_BYOD = False",
    ...
    # Stage 6: bounded decoder fine-tuning
...
MARKDOWN_MARKERS = (
    ...
    "The upstream asset is a pickle",
    "unpickles it exactly once",
    "already fine-tuned on this dataset",
    "no-water baseline",
    "not calibrated probabilities",
    "BatchNorm",
    "Split by scene or event",
    "sample-sanity",
    "CC BY 4.0",
)
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    60_333_632: "prithvi-flood adapter.safetensors from the tutorial run (46 tensors)",
    103_757_095: "Sen1Floods11 v1.1 HandLabeled tutorial subset: 88 pinned objects in total",
    1_276_749_320: "prithvi-eo-2.0-300m-tl-sen1floods11.safetensors converted locally from 91ce9d3 .pt",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "5b9f0ba08490293d6c17b9cef219991e1a6edda31609429679f8dca1af5a7b10": "audit_pickle digest of sorted globals in Prithvi-EO-V2-300M-TL-Sen1Floods11.pt data.pkl",
    "65e4377f96c651dff586bf6ef08c9b8d6c6b59c4dc05e5dfbfe320b264ac47fd": "SHA-256 of converted prithvi-eo-2.0-300m-tl-sen1floods11.safetensors (git-ignored)",
}
