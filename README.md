...
**Candidate** — the notebook source passes all static checks and one local GPU pre-flight execution of the generated notebook is recorded; a clean run in a supported hosted runtime is still required (see `STATUS.md` and `docs/release-verification.md`).
